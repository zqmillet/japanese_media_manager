...
def test_get_number(file_name, expected_output):
    assert get_number(file_name) == expected_output
...
def test_get_nothing(file_name):
    assert get_number(file_name) is None
